...
/**
 * Clase que representa un consumidor en el sistema.
 * Los consumidores toman los tickets de la cola y los asignan a los reparadores.
 * 
 * Los tickets son procesados en orden de prioridad y los reparadores intentan resolverlos
 * en base a su nivel de habilidad.
 * 
 */
public class Consumidor implements Runnable {
    ...
    /**
     * Método ejecutado por el hilo consumidor.
     * Procesa los tickets en la cola asignándolos a los reparadores disponibles.
     */
    @Override
    public void run() {
        while (true) {
            try {
                ...
                // Iterar sobre los reparadores para intentar resolver el ticket
    ...
    /**
     * Determina si un reparador puede resolver un ticket, basado en su habilidad y dificultad del ticket.
     * 
     * La probabilidad de éxito se calcula comparando el nivel del reparador
     * con el nivel de dificultad del ticket, ajustado con un valor base.
     *
